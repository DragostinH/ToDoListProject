...
/***/ "./src/createStorageStructure.js":
/*!***************************************!*\
  !*** ./src/createStorageStructure.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ createStorageStructure)\n/* harmony export */ });\nfunction createStorageStructure() {\n    let itemToStringify;\n    let myStorage = localStorage;\n    let projectsArr = [\n        {\n            name: 'Inbox',\n            tasks: []\n        },\n        {\n            name: 'Today',\n            tasks: []\n        },\n        {\n            name: 'Upcoming',\n            tasks: []\n        }\n    ]\n\n    itemToStringify = JSON.stringify(projectsArr);\n    myStorage.Projects = itemToStringify;\n\n    return myStorage;\n}\n\n//# sourceURL=webpack://todolistproject/./src/createStorageStructure.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _addClassToElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addClassToElement */ \"./src/addClassToElement.js\");\n/* harmony import */ var _appendMultiple__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./appendMultiple */ \"./src/appendMultiple.js\");\n/* harmony import */ var _createAddTaskBtn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createAddTaskBtn */ \"./src/createAddTaskBtn.js\");\n/* harmony import */ var _createDiv__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createDiv */ \"./src/createDiv.js\");\n/* harmony import */ var _createListElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createListElement */ \"./src/createListElement.js\");\n/* harmony import */ var _createStorageStructure__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createStorageStructure */ \"./src/createStorageStructure.js\");\n/* harmony import */ var _createTodoEntry__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./createTodoEntry */ \"./src/createTodoEntry.js\");\n/* harmony import */ var _createTodoForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./createTodoForm */ \"./src/createTodoForm.js\");\n/* harmony import */ var _inbox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./inbox */ \"./src/inbox.js\");\n/* harmony import */ var _today__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./today */ \"./src/today.js\");\n/* harmony import */ var _upcoming__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./upcoming */ \"./src/upcoming.js\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nconst indexPage = (() => {\n    // Always load the inbox first:\n    (0,_inbox__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\n\n    const myStorage = window.localStorage;\n    const storageKeys = Object.keys(myStorage);\n\n    const inboxBtn = document.querySelector('.inbox-btn');\n    const todayBtn = document.querySelector('.today-btn');\n    const upcomingBtn = document.querySelector('.upcoming-btn');\n    const addTaskBtn = document.querySelector('.add-task-btn');\n    const main = document.querySelector('main');\n    const ulInbox = document.querySelector('.task-list.inbox');\n\n\n\n    inboxBtn.onclick = () => {\n        const ulToRemove = document.querySelector('.task-list');\n        const titleToRemove = document.querySelector('h2');\n        main.removeChild(ulToRemove);\n        main.removeChild(titleToRemove);\n        (0,_inbox__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\n    }\n\n    todayBtn.onclick = () => {\n        const ulToRemove = document.querySelector('.task-list');\n        const titleToRemove = document.querySelector('h2');\n        main.removeChild(ulToRemove);\n        main.removeChild(titleToRemove);\n        (0,_today__WEBPACK_IMPORTED_MODULE_9__[\"default\"])();\n    }\n    upcomingBtn.onclick = () => {\n        const ulToRemove = document.querySelector('.task-list');\n        const titleToRemove = document.querySelector('h2');\n        main.removeChild(ulToRemove);\n        main.removeChild(titleToRemove);\n        (0,_upcoming__WEBPACK_IMPORTED_MODULE_10__[\"default\"])();\n    }\n\n\n\n    // Storage manipulation -----------\n    if (storageKeys.length > 0) {\n        console.log('There is stored data')\n    } else {\n        console.log(\"There isn't stored data.\")\n        console.log(\"Created storage structure.\")\n        ;(0,_createStorageStructure__WEBPACK_IMPORTED_MODULE_5__[\"default\"])();\n    }\n\n\n\n\n\n})()\n\n//# sourceURL=webpack://todolistproject/./src/index.js?");
